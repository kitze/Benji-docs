...
- **Create a new packing item**: opens the packing item form
- **Create a new packing activity**: opens the activity form
- Navigation shortcuts to the Packing pages

## ⌨️ Keyboard Shortcuts

- `Cmd/Ctrl + K`: open Alfred to access Packing commands
