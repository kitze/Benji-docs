...
Enable Locations from `Settings → Features → Locations`. See the [Enabling Features guide](/docs/enabling-features) for details on feature toggles and visibility options.
...
- Search for existing locations to jump directly to them
- **Create a new location**: opens the location creation form
- **Log visit**: opens the Activity Log form

## ⌨️ Keyboard Shortcuts

- `Cmd/Ctrl + K`: open Alfred to access Locations commands
