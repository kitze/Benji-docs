...
- If you manage a recurring route, log the visit from the card menu on mobile—the Log Today/Yesterday shortcuts run instantly and keep your recency groups accurate.
