...
Enable Workouts from `Settings → Features → Workouts`. See the [Enabling Features guide](/docs/enabling-features) for details on feature toggles and visibility options.
