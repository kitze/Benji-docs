...
Enable Pomodoros from `Settings → Features → Pomodoros`. See the [Enabling Features guide](/docs/enabling-features) for details on feature toggles and visibility options.
