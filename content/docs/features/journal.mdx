...
- Toggle Journal on from `Settings → Features → Journal` to add it to your sidebar or mobile toolbar.
...
- Journal entries never auto-post to the public timeline.
...
- Spotlight offers **Create a new journal entry** (opens the full page) and **Create a quick journal entry** (opens the modal so you can jot something without leaving your view).
- The Journal page itself exposes **Write** buttons on desktop and mobile, plus templates in the sidebar for one-click reuse.

## 🤖 Automation & AI

- There’s no AI assistant for Journal yet. Templates are the fastest way to reuse prompts without relying on automation.
...
- Multi-select is desktop-first: hold `Cmd/Ctrl` when clicking cards to bulk encrypt or delete. On touch devices, use the long-press selection affordance.
