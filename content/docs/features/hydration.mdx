...
Hydration keeps you honest about how much water you’re really drinking. Pop in each glass or bottle during the day and watch your goal fill up, so the “did I drink enough?” question is answered before the afternoon headache hits.

## 🚪 Access & Activation

Enable Hydration from `Settings → Features → Hydration`. See the [Enabling Features guide](/docs/enabling-features) for details on feature toggles and visibility options.
...
![Hydration page showing daily goal progress, recent logs, and the calendar sidebar.](/images/features/hydration/hydration-main.png)
...
- Saved templates appear as quick actions—type the template name to log instantly
