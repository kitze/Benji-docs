...
Projects live inside the Todos feature. Enable `Settings → Features → Todos`. See the [Enabling Features guide](/docs/enabling-features) for details.

Open the **Projects** tray in the todo sidebar to browse active projects, accept invites, or create a new one. Creating a project inside a shared list automatically copies the parent's collaborators so the same people stay in sync.
...
- **Create a project**: opens the project creation form
- **Create from template**: starts a new project from an existing template
- **Open the Projects board**: launches the Kanban view
- Jump directly to specific projects by name

## ⌨️ Keyboard Shortcuts

- `q`: quick add
- `Cmd/Ctrl + K`: open Alfred to access Projects commands
