...
Enable Habits from `Settings → Features → Habits`. See the [Enabling Features guide](/docs/enabling-features) for details on feature toggles and visibility options.
...
- **Create a new habit**: opens the habit creation form
- Search for existing habits or lists to jump directly to them
...
- `Cmd/Ctrl + K`: open Alfred to access Habits commands
