...
Enable Problems from `Settings → Features → Problems`. See the [Enabling Features guide](/docs/enabling-features) for details on feature toggles and visibility options.
...
- `Cmd/Ctrl + K`: open Alfred to access Problems commands
