...
Enable Trips from `Settings → Features → Trips`. See the [Enabling Features guide](/docs/enabling-features) for details on feature toggles and visibility options.
...
- **Create a new trip**: opens the trip creation form
- Navigation shortcuts to Trips, Stays, Transports, and packing pages

## ⌨️ Keyboard Shortcuts

- `Cmd/Ctrl + K`: open Alfred to access Trips commands
