...
Enable Activities from `Settings → Features → Activities`. See the [Enabling Features guide](/docs/enabling-features) for details on feature toggles and visibility options.
